...
# Fix: MODEL_PATH should be a string path, not a loaded model
MODEL_PATH = 'c:\\Users\\asus\\best_resnet50v2.h5'
IMAGE_WIDTH = 224
IMAGE_HEIGHT = 224
CLASS_LABELS = ['burger', 'cake', 'chicken', 'donuts', 'fries', 'hot_dog', 'ice_cream', 'pizza', 'sandwich', 'waffles']
